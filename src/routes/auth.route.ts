...
import { AuthMiddlewares, authMiddlewares } from '../middlewares/protected-route.middleware';
...
class AuthRoutes {
  ...
  public protectedRoutes = (): Router => {
    this.router.post('/auth/change-password', authMiddlewares.verifyUser, ChangePassword.prototype.update);
    this.router.post('/auth/telegram-set-password', authMiddlewares.verifyUser, SetTelegramPassword.prototype.update);
    this.router.post('/auth/telegram-check-password', authMiddlewares.verifyUser, CheckTelegramPassword.prototype.read);
